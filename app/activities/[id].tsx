...
export default function ActivityDetailScreen() {
  ...
  const { data: reviews = [], refetch: refetchReviews } =
    trpc.activityReviews.list.useQuery(
      { activityCode: id || "" },
      { enabled: !!id }
    );
  ...
  const addReviewMutation = trpc.activityReviews.add.useMutation({
    onSuccess: () => {
      ...
      Alert.alert(
        ...
        isRTL ? "تم إضافة تقييمك بنجاح." : "Your review has been submitted."
      );
    },
    onError: () =>
      Alert.alert(
        isRTL ? "خطأ" : "Error",
        isRTL ? "فشل إضافة التقييم." : "Failed to submit review."
      ),
  });
    ...
    try {
      await Share.share({
        ...
        message: `${activity.name}\n${
          isRTL ? "السعر يبدأ من" : "Price from"
        } ${activity.minPrice} ${activity.currency}\n${
  ...
  const handleOpenMap = async () => {
    ...
    const label = encodeURIComponent(activity.name || "Location");
    ...
    try {
      ...
      Alert.alert(
        isRTL ? "خطأ" : "Error",
        isRTL ? "تعذر فتح الخريطة." : "Unable to open the map."
      );
    }
  };
      ...
      <ScreenContainer>
        ...
        <View style={styles.center}>
          ...
          <Text style={[styles.emptyTitle, { color: colors.foreground }]}>
            {isRTL ? "لم يتم العثور على النشاط" : "Activity not found"}
          </Text>
          <Pressable
            style={({ pressed }) => [
              styles.backBtnLarge,
    ...
    <ScreenContainer>
      ...
      >
          ...
          <View style={styles.shareButtons}>
            ...
            >
              <Text style={{ fontSize: 18 }}>
                {favActivity && isFavorite(favActivity.code) ? "❤️" : "🤍"}
              </Text>
            </Pressable>
          </View>
        </View>
        ...
        <View style={styles.content}>
          ...
          {activity.description ? (
            <View style={styles.section}>
              <Text style={[styles.sectionTitle, { color: colors.foreground }]}>
                {isRTL ? "عن النشاط" : "About this activity"}
              </Text>
          ...
          <View style={styles.section}>
            <Text style={[styles.sectionTitle, { color: colors.foreground }]}>
              {isRTL ? "ما يميز هذا النشاط" : "Highlights"}
            </Text>
            ...
            <View style={styles.highlightsList}>
              <View style={styles.highlightItem}>
                ...
                />
                <Text
                  style={[styles.highlightText, { color: colors.muted }]}
                >
              ...
              <View style={styles.highlightItem}>
                ...
                >
                  {isRTL
                    ? "إلغاء مجاني حتى 24 ساعة قبل البدء"
          ...
          {(activity.latitude && activity.longitude) ? (
            <View style={styles.section}>
              <Text style={[styles.sectionTitle, { color: colors.foreground }]}>
                {isRTL ? "موقع النشاط" : "Activity Location"}
              </Text>
                  ...
                  {[1, 2, 3, 4, 5].map((s) => (
                    <Pressable key={s} onPress={() => setReviewRating(s)}>
                      <Text
                        style={{
                          fontSize: 28,
                          color: s <= reviewRating ? "#F59E0B" : colors.border,
                        }}
                      >
                        ★
                      </Text>
                    ...
                    style={({ pressed }) => [
                      {
                        ...
                        alignItems: "center",
                        opacity:
                          pressed || addReviewMutation.isPending ? 0.7 : 1,
                      },
                    ]}
          ...
          >
            <Text style={styles.bookBtnText}>
              {isRTL ? "احجز هذا النشاط" : "Book this activity"}
            </Text>
