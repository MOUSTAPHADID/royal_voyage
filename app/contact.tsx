...
const T: Record<Lang, {
  ...
  ar: {
    ...
    faqs: [
      ...
      { q: "هل أنتم وكالة سفر معتمدة؟", a: "نعم، Royal Voyage هي علامة تجارية لشركة ROYAL SERVICE L. المرخصة في موريتانيا، ونعمل كوسيط معتمد مع شركات الطيران والفنادق عبر شريكنا التقني Duffel." },
    ],
  },
  en: {
    dir: "ltr",
    ...
    faqs: [
      ...
      { q: "Are you a certified travel agency?", a: "Yes, Royal Voyage is a brand of ROYAL SERVICE L., licensed in Mauritania. We operate as a certified intermediary with airlines and hotels through our technology partner Duffel." },
    ],
  },
  fr: {
    dir: "ltr",
    ...
    faqs: [
      ...
      { q: "Êtes-vous une agence de voyage certifiée ?", a: "Oui, Royal Voyage est une marque de ROYAL SERVICE L., agréée en Mauritanie. Nous opérons en tant qu'intermédiaire certifié avec les compagnies aériennes et hôtels via notre partenaire technologique Duffel." },
    ],
  },
};
