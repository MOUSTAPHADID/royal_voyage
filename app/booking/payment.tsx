...
const PAYMENT_METHODS: {
...
}[] = [
  {
    id: "bankily",
    label: "🏦 بنكيلي",
    sublabel: "الدفع الفوري عبر تطبيق Bankily - الأسرع والأسهل",
  ...
  },
  {
    id: "sedad",
    label: "💳 سداد",
    sublabel: "منصة سداد الموثوقة - دفع آمن وسريع",
  ...
  },
  {
    id: "masrvi",
    label: "📱 مصرفي",
    sublabel: "الدفع عبر تطبيق مصرفي - محفظة رقمية",
  ...
  },
  {
    id: "stripe",
    label: "💰 بطاقة بنكية",
    sublabel: "Visa / Mastercard - دفع دولي آمن عبر Stripe",
